...
func (*DoubleMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_floats_e296205954c2f39e, []int{0}
}
...
func (*FloatMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_floats_e296205954c2f39e, []int{1}
}
...
func init() {
	proto.RegisterType((*DoubleMessage)(nil), "schema.proto2.DoubleMessage")
	proto.RegisterType((*FloatMessage)(nil), "schema.proto2.FloatMessage")
}

func init() { proto.RegisterFile("floats.proto", fileDescriptor_floats_e296205954c2f39e) }

var fileDescriptor_floats_e296205954c2f39e = []byte{
	...
	0x84, 0xf0, 0x8c, 0x94, 0x6c, 0xb9, 0x78, 0x5d, 0xf2, 0x4b, 0x93, 0x72, 0x52, 0x7d, 0x53, 0x8b,
	...
	0x76, 0xdd, 0x4c, 0x30, 0xdd, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd9, 0xee, 0x44, 0x9c, 0x9a,
	0x00, 0x00, 0x00,
}
